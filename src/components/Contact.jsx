                ...
                <div className='flex items-center gap-2 mt-auto lg:mt-0'>
                    {
                        socialLinks.map(({href, icon, alt}, key) => (
                            <a href={href} key={key} target='_blank' className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-all hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80' alt={alt}>
                                {icon}
                            </a>
                        ))
                    }
